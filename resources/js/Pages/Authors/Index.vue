    ...
    <div class="row mt-5">
        ...
        <div class="col-md-6">
            ...
            <div class="mt-4 text-center">
                ...
                <p>
                    <a
                        href="https://github.com/soungoolwin"
                        target="_blank"
                        class="link-dark"
                        ><i class="fa-brands fa-github mr-2"></i>Follow me on
                        Github</a
                    >
                </p>
                <p>
                    <a
                        href="https://medium.com/@soungoolwin"
                        target="_blank"
                        class="link-dark"
                        ><i class="fa-brands fa-medium mr-2"></i> Follow me on
                        Medium</a
                    >
                </p>
                <!-- <p>
